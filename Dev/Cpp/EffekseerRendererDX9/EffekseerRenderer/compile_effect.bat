...
"%DXSDK_DIR%Utilities\\bin\x86\fxc" /Zpc /Tvs_2_0 /EVS /Fh Shader/EffekseerRenderer.ModelRenderer.Shader_VS.h Shader/model_renderer_VS.fx

"%DXSDK_DIR%Utilities\\bin\x86\fxc" /Zpc /Tvs_2_0 /EVS /Fh Shader/EffekseerRenderer.ModelRenderer.ShaderLightingNormal_VS.h Shader/model_renderer_lighting_normal_VS.fx
"%DXSDK_DIR%Utilities\\bin\x86\fxc" /Zpc /Tvs_2_0 /EVS /Fh Shader/EffekseerRenderer.ModelRenderer.ShaderLightingTextureNormal_VS.h Shader/model_renderer_lighting_texture_normal_VS.fx
